const game = {
    authors: 'Javier, Mariano, Laura, Blanca, Joyce',
    version: '1.0',
    title: 'Fly & Poop',
    score: 0,
    width: null,
    ...
    gameAudio: new Audio("./onlymp3.to - soundtrack_from_pou_______sky_jump__good_quality_-6sUE15ocU9E-192k-1689330106"),
    ...
    init() {
        ...
        this.start()
        this.gameAudio.play()
        console.log("EL SONIDO =>", this.gameAudio)
    },
